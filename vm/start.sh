...
# pintos --fs-disk=10 -p tests/vm/page-merge-par:page-merge-par -p tests/vm/child-sort:child-sort --swap-disk=10 -- -q   -f run page-merge-par 
...
# pintos -v -k -T 60  --fs-disk=10 -p tests/vm/page-merge-stk:page-merge-stk -p tests/vm/child-qsort:child-qsort --swap-disk=10 -- -q   -f run page-merge-stk 
...
pintos -v -k -T 60  --fs-disk=10 -p tests/vm/page-merge-mm:page-merge-mm -p tests/vm/child-qsort-mm:child-qsort-mm --swap-disk=10 -- -q   -f run page-merge-mm 
...
# pintos -v -k -T 60 -m 20   --fs-disk=10 -p tests/userprog/write-normal:write-normal -p ../../tests/userprog/sample.txt:sample.txt --swap-disk=4 -- -q   -f run write-normal 
# < /dev/null 2> tests/userprog/write-normal.errors > tests/userprog/write-normal.output
...
# < /dev/null 2> tests/userprog/fork-once.errors > tests/userprog/fork-once.output
...
# < /dev/null 2> tests/vm/mmap-exit.errors > tests/vm/mmap-exit.output
...
# < /dev/null 2> tests/vm/mmap-write.errors > tests/vm/mmap-write.output
...
# pintos -v -k -T 60 -m 20   --fs-disk=10 -p tests/vm/mmap-ro:mmap-ro -p ../../tests/vm/large.txt:large.txt --swap-disk=4 -- -q   -f run mmap-ro 
# pintos --gdb   --fs-disk=10 -p tests/vm/mmap-ro:mmap-ro -p ../../tests/vm/large.txt:large.txt --swap-disk=4 -- -q   -f run mmap-ro 
# < /dev/null 2> tests/vm/mmap-ro.errors > tests/vm/mmap-ro.output
